<h2><a href="https://www.geeksforgeeks.org/problems/longest-common-prefix-in-an-array5129/1?page=2&company=Amazon,Microsoft,Flipkart,Google,Samsung,Facebook,Cisco,Linkedin,Yahoo,PayPal,TCS,Twitter,Myntra,Atlassian,Apple,Infosys&difficulty=Easy&sortBy=submissions">Longest Common Prefix in an Array</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given an array of <strong>N</strong> strings, find the longest common prefix among all strings present in the array.</span></p>
