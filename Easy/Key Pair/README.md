<h2><a href="https://www.geeksforgeeks.org/problems/key-pair5616/1?page=2&company=Amazon,Microsoft,Flipkart,Google,Samsung,Facebook,Cisco,Linkedin,Yahoo,PayPal,TCS,Twitter,Myntra,Atlassian,Apple,Infosys&difficulty=Easy&sortBy=submissions">Key Pair</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given an array <strong>Arr</strong> of <strong>N</strong> positive integers and another number <strong>X</strong>. Determine whether or not there exist two elements in <strong>Arr</strong> whose sum is exactly <strong>X</strong>.</span></p>
