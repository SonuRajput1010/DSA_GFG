<h2><a href="https://www.geeksforgeeks.org/problems/summed-matrix5834/1?page=1&difficulty=Easy&sprint=ca8ae412173dbd8346c26a0295d098fd&sortBy=accuracy">Summed Matrix</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">A matrix is constructed of size <strong>n</strong>*<strong>n</strong>. such that M<sub>i</sub><sub>,j</sub>= i+j. Count the number of cells having value <strong>q</strong>.<br>
